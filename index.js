...
async function fetchReport(data) {
    ...
    const messages = [
        {
          role: 'system', 
          content: 'You are a trading guru. Take the incoming data on share prices over the past 3 days and write a report of no more than 160 words describing the stock performance and recommending whether to buy, hold or sell. Format output to not include any special characters. Use examples provided between ### to set the style and tone of your response'
        }, 
        {
            role: 'user', 
            content:`${data}
    ...
    */
    ...
    loadingArea.innerText = 'Unablle to access AI. Please refresh and try again.'
}
}
